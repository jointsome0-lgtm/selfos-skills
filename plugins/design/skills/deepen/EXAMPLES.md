...
Invented fixtures — an imaginary repository `atlas` with an SDD, a Decision Log, and an importer subsystem. Nothing here refers to a real project.
...
> "Anything worth deepening in atlas?"
