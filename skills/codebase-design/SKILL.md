...
- **Exploring alternative interfaces** — see [DESIGN-IT-TWICE.md](DESIGN-IT-TWICE.md): design the interface several radically different ways — parallel sub-agents where the harness supports them, sequential independent passes otherwise — then compare on depth, locality, and seam placement.
