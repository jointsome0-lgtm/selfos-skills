...
This stateful workflow runs only when the user explicitly asks to start or continue teaching. Read [INSTRUCTIONS.md](INSTRUCTIONS.md) in full and follow its Markdown body plus the bundled format files.
