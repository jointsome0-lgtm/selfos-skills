...
license: LICENSE.txt
compatibility: Requires read/write access to a user-approved learning workspace and network access to research and cite trusted resources. No specific CLI, OS, or authenticated external integration; generated lessons are self-contained HTML.
metadata:
